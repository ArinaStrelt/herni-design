...
@export var camera_distance: float = 0  # Vzdálenost kamery od hráče
@export var camera_height: float = 0  # Výška kamery nad hráčem
@export var camera_angle: float = 0  # Úhel pohledu (opraveno float)
